//
//  DSGLProjectionDemoView.m
//  gpuimagedemo
//
//  Created by zhangchong on 15-3-25.
//  Copyright (c) 2015年 vitonzhang. All rights reserved.
//

#import "DSGLProjectionDemoView.h"
...
static const Vertex Vertices[] = {
    {{1, -1, -7}, {1, 0, 0, 1}}, // v0 Red
    {{1, 1, -7}, {0, 1, 0, 1}},  // v1 Green
    {{-1, 1, -7}, {0, 0, 1, 1}}, // v2 Blue
    {{-1, -1, -7}, {0, 0, 0, 1}} // v3 Black
};
...
@implementation DSGLProjectionDemoView
{
...
- (void)renderSquare {
    ...
    NSLog(@"projection: %@", [projection description]);
