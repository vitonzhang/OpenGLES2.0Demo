...
#import "DSGLModelTransformView.h"
...
@implementation DSGLModelTransformView
{
...
- (void)renderSquare {
    ...
    [modelview populateFromTranslation:CC3VectorMake(0, sin(CACurrentMediaTime()), -7)];
